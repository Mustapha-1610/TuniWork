...
// send freelancer a mail upon sign up (aziz)
export const SendCompanyAccountConfirmationMail = async (
  name: String,
  email: any,
  companyId: any,
  ...
  <h1>TuniWork company Account Activation</h1>
